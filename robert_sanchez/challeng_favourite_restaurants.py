...
print(f"the {restaurant['name']} is locate at {restaurant['latitude']} and {restaurant ['longitude']}")
# TODO: Write code to print the complete address of the Four Barrel Coffee, formatted as a string - it should include the address, city, state and the zip code.
print(f'The complete address of {restaurant["name"]} is in {restaurant["city"]}, {restaurant["state"]},{restaurant["address1"]}, {restaurant["zip_code"]}')
# TODO: Write code to print the URL of the website of Four Barrel Coffee.
print(f"the {restaurant['name']} website is {restaurant['url']}")
...
fav_restaurant = {'Sofrito' :
["679 Riverside Dr, New York 10031", "Ensalada de Pulpo", "12PM to 10PM"], 
'Sammys' : ["City_Island, Bronx, NY 10467", "Lobster", "12PM to 10PM"],
'Jimmys' : ["New_York, New_York, NY 10025", "Mei_Fen", "1PM to 10PM"]}
