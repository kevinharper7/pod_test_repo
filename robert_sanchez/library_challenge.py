...
print(type(books)) # books is a list
...
search_by_name('SILENCE OF THE LAMB')
...
#a list with 16 dictionaries. List use hard brackets, dictionalries use curly brackets
...
def search_by_author(author):
    ...
    for book in books_with_details:
        ...
        if book['author']== author:
            # to our author_books list add title
