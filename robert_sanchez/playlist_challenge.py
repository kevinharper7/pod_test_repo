...
'''
add_song(my_playlist, {'artist': 'George Michael', 'title': 'Carless Whispers'})
display_playlist(my_playlist)
...
add_song(my_playlist, {'artist': 'ESG', 'title': 'UFO'})
add_song(my_playlist, {'artist': 'Jellybean', 'title': 'The Mexican'})
...
average = np.mean(monthly_plays) # install numpy
print(average)
