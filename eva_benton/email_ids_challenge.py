...
#lowercase version of employee name
...
#separate employee first name from last name
...
# employee first name and last name saved in new variable
...
#employee joined first name and last name with email suffix
...
names = ['Max Bartlett', 'Angelita Norris', 'Stewart Mueller', 'Dominique Henry', 'Carmela Gross',
 'Bettie Mcmillan', 'Sara Ellison', 'Ira Anthony', 'Pauline Riley', 'Ben Weber', 'Joanne Mcknight',
 'Loren Gould', 'Jamar Singh', 'Amanda Vance', 'Tyrell Andrade', 'Jana Clements', 'Eddy Mcbride', 
 'Marsha Meyer', 'Elbert Shannon', 'Alyce Hull']
