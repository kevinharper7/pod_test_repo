...
# 3 pt shots made by Jamal Murray
jamal_murray_3pts_made = 46

# 3 pt shots made by Fred VanVleet
fred_vanvleet_3pts_made = 43

# 3 pt shots made by James Harden
james_harden_3pts_made = 37

print("Challenge 2.2:")
# number of 3 point shots made by jamal Murray
print(f"In 2020 NBA playoffs, Jamal Murray made {jamal_murray_3pts_made} 3 point shots")

# TODO: Create print statement here for Fred VanVleet
# number of 3 point shots made by fred vanvleet
print(f"In 2020 NBA playoffs," fred vanvleet made {fred_vanvleet_3pts_made} )

# TODO: Create print statement here for James Harden
# number of 3 point shots made by james harden
print(f"In 2020 NBA playoffs," james harden made {james_harden_3pts_made} )
