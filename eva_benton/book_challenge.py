...
print('PART 1\n')
my_library = Booklist() #object of Booklist class
...
print(my_library.books)
print("\n")
# my_library.remove_title(title = 'Just Mercy')
# print("\n")

print(my_library.remove_title(title = 'Just Mercy'))
print("\n")
...
My partial answer, these are the books I will be using from NYT list: 'We Begin At The End', Chris Whitaker
'The Midnight Library', Matt Haig. 
'''

print('\nPart 5\n')
nyt_bestsellers = Booklist() #another object of Booklist class

print(type(nyt_bestsellers.books))
print('\n')
print(nyt_bestsellers.count_books())
print(nyt_bestsellers.books)
print('\n')


nyt_bestsellers.add(title = 'We Begin At The End', author = 'Chris Whitaker')
nyt_bestsellers.add(title = 'The Midnight Library', author = 'Matt Haig')
print(nyt_bestsellers.books)
...
# With Serena:
#create an empty list called titles or sorted_titles or display_titles()
#loop through self.books (each item in self.books is a dictionary with title and author keys)
#append the title to your new list (titles or sorted_titles)
#use titles.sort() to alphabetically sort titles, then print or return that 
