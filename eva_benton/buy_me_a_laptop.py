...
# Code to print all laptop names.
print("All laptops names:")

# All laptop names
# Code in for-loop to print all laptop names.
...
# Code to print MacBook Pro url.
print(laptops[0]["url"])

# TODO: Write code to print all possible prices of the 16-inch MacBook Pro.
# Code in f-string to print all possible prices of the 16-inch MacBook Pro.
print(f' Possible prices{laptops[0]["types"][1]["price"]}')


# TODO: Write code to print all the color options for Dell XPS 13.
# Code to print all the color options for Dell XPS 13.
# Code  in f-string to print all the color options for Dell XPS 13.
print(f' Possible colors{laptops[1]["types"][0]["colors"]}')


# TODO: Write code to print the description of Dell XPS laptop.
# Code to print the description of Dell XPS laptop.
...
# Code to create updated laptops dictionary with updated color and storage.
mac_color = laptops[0]["types"][0]["colors"] = ["silver"]
mac_storage = laptops[0]["types"][1]["storage"] = ["512 GB"]


# Code to print updated dictionary.
print(mac_color)
print(mac_storage)
...
# Code in f-string to print all possible prices for the laptops.
