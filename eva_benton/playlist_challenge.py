...
'''
add_song(my_playlist, {'artist': 'Nas', 'title': 'The world Is Yous'})
...
print('Question 5')
add_song(my_playlist, {'artist': 'Pat Metheny', 'title': 'Are You Going With Me?'})
display_playlist(my_playlist)

add_song(my_playlist, {'artist': 'Winton Marsallas', 'title': 'Think Of One'})
display_playlist(my_playlist)
print("\n")
