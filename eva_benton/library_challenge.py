...
# 1.0
# Extracting the the data type of the object 'books' 
print(type(books))

# 1.1
# Defining the function and variable 'available_books' to create a book list.
# Parameters: not needed for this finction
# Return: not needed
def available_books():
    print(books)
 
# 1.2
# Running the 'available_books' function. 
available_books()

# 1.3
# Using .remove funtion to remove a book fron the list of books.
...
# 1.4
# Checking out the book titled 'SAPIENS' using the check_out function.
check_out('SAPIENS')
available_books()
...
# Adding a book to the list using the function append.
def check_in(book):
    books.append(book)

# 1.6
# Check in 'SAPIENS' using the check_in function
# Creating a check_in function to check in books to library list.
...
# Parameters: book (string)
# Return: Not needed for this function
# Creating a function using 'search_by_name' which will print 'Avaiable' if book exists in the library list of books.
...
# Creating a search function for a specific book, calling the function and the running the function.
search_by_name('JUST MERCY')

search_by_name('SILENCE OF THE LAMBS')
...
# (My answer) Books with details is a list of dictionaries. 
# (My answer)The types of data that are nested within each dictionary are key value pairs with strings, that detail the title of the book, the author of the book, and the book description.
...
# Creating 'count_books' function to count the number of books in the books_with_details list.
def count_books():
    return len(books_with_details)

# 2.2
# Check the number of books available in the books list using the count_books function
# The number of books available in the books list using the count_books function.
print(count_books())
...
# Using function 'search_by_author' I anm creating code to return titles of books by a specific author.

def search_by_author(author):
    author_books = []
    for book in books_with_details:
        # Book's author matches the search term.
        if book['author'] == author:
            # To our author_books list add this title.
...
# 2.4
# Search for book titles by the author 'Timothy Snyder' using the search_by_author functionlibrary
# Creating a searh for book titles bt a specific autor, using the search_by_author function.
