...
# Defining 'playlist' function which requires two arguments:'playlist' (a list), and 'song' (a dictionary)
...
'''
# Defining a function called get_playlist_length(), using a single parameter, returning an integer value indicating how many songs there are.
