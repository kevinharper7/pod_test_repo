...
#from wolfpack_pod_repo.maximum_flournoy.playlist_functions import display_playlist
#from wolfpack_pod_repo.maximum_flournoy.playlist_functions import display_playlist
...
add_song(my_playlist,{'artist': 'Nas', 'title': 'The World is Yours'})
...
print('Question 5')
add_song(my_playlist, {'artist': 'Buddy', 'title': 'Burberry'})
add_song(my_playlist, {'artist': 'Future', 'title': 'Mask off'})
