...
print(results['artists']['items'][0]['name']) # uncomment if you want to see the results #add s to result on lines 75-77
#print(results['artists']['items'][1]['name']) # uncomment if you want to see the results
#print(results['artists']['items'][2]['name']) # uncomment if you want to see the results


# lets get the artist id, so that we can look up more stuff for them
# each artist has a unique ID like this

#"uri": "spotify:artist:28zkbG1FOcvawYeqA8zRm0"
artist_id = "spotify:artist:28zkbG1FOcvawYeqA8zRm0"   # fill this in
...
# Followers is a dictionary itself, with the value 'total' being the total followers. How can we access it?
...
chosen_artists = ['Future', 'Nelly', 'Nas', 'Iamsu', 'Ice Cube']
popularities = []
...
print(popularities)
# Future91 Nelly79 Nas77 Iamsu65 Ice Cube77
print("Bonus!")
...
sim = sp.artist_related_artists(popularities[1]['id'])   # fill this in
jprint(sim['artists'][:3]) # uncomment this like to see what the top 3 similar artists are



# Print the artist name and popularity
jprint(sim['artists'][0]['name'])
jprint(sim['artists'][0]['popularity'])
# Twista71, Baby Bash68, Chingy62