...
email = joined_names + company_email
...
# 2.2 TODO: Inside the "for" loop, create the email id by re-usinsg the logic from Question 1 and...
# 2.3 TODO: ..add the email to the emails list

for person in names:
    lower_name = person.lower()
   # print(lower_name)
    lower_name = person.split()
    #print(lower_name)
    lower_name = '.'.join(lower_name)
    #print(lower_name)
    email = lower_name + company_email
