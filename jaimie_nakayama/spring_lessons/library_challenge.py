...
# It's a list. It's held in hard brackets.
print(type(books))
...
# a list with 16 dictionaries. Lists use hard brackets, dictionaries use curly brackets.
...
def search_by_author(author):
    ...
    for book in books_with_details:
       ...
       if book['author'] == author:
           #if author is on the list, add it to new authors_book list
